#!/usr/bin/env bash
# Launches App 3 (synced 3-screen slideshow) — LEFT role.
# Designed to be run on login by com.intersolar.app3-left.plist.
#
# LEFT is the display to the left of the macOS Main Display.
...
PROFILE_DIR="$HOME/.kiosk-app3-left-profile"
