#!/usr/bin/env bash
# Double-click this file in Finder to install App 1 (slideshow)
# as the kiosk that auto-starts on every login.
#
# Equivalent to running `./kiosk/install.sh app1` in Terminal.
#
...
cat <<'BANNER'
╔══════════════════════════════════════════════════════════════╗
║  Install App 1 — Victron slideshow kiosk                     ║
╚══════════════════════════════════════════════════════════════╝

Installing the LaunchAgent that will auto-start App 1 (slideshow)
every time this Mac logs in.
...
✓ App 1 is installed.
  ...
  automatically. To start it right now without rebooting:
      launchctl start com.intersolar.app1
OK
else
